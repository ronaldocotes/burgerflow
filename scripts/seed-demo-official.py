...
PRODUCTS = [
    ...
    ("Sobremesas",              "PTG001",               "Petit Gateau",            "Bolinho de chocolate com centro derretido quente, servido com sorvete de baunilha e frutas vermelhas",  2800,  None,  2,  False, None,                                                                          None, None, None),
