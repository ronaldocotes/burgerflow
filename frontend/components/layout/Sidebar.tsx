...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: '/plataforma/chaves',      label: 'Chaves de API', icon: KeyRound,       roles: ['SUPER_ADMIN'] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/trafego-pago', label: 'Tráfego Pago',  icon: TrendingUp, roles: ['ADMIN', 'MANAGER'] },
