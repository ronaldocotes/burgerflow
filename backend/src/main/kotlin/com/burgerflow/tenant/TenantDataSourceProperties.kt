 ...
 */
@ConfigurationProperties(prefix = "burgerflow.tenant")
data class TenantDataSourceProperties(
    /** JDBC host:port, e.g. localhost:5432 */
    val host: String = "localhost:5432",
    val username: String = "burgerflow",
    val password: String = "burgerflow123",
    ...
    val controlDb: String = "burgerflow_control",
    /**
