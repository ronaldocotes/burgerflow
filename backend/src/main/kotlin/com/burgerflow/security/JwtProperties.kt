package com.burgerflow.security

import org.springframework.boot.context.properties.ConfigurationProperties

@ConfigurationProperties(prefix = "burgerflow.jwt")
data class JwtProperties(
    /** HS256 secret. MUST be overridden via env in prod; >= 32 bytes. */
    val secret: String = "change-me-in-prod-burgerflow-dev-secret-key-256bits!",
